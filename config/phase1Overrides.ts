...
export const phase1Overrides: Record<string, ToolOverride> = {
  ...
  "seed-spacing-calculator": {
    ...
    quickAnswer: {
      ...
      columns: ["Crop", "Row spacing", "Plant spacing"],
      rows: [
        ["Tomato", "36 in", "24 in"],
        ["Cucumber", "36 in", "12 in"],
        ["Lettuce", "12 in", "8 in"],
        ["Carrot", "12 in", "3 in"],
        ["Pepper", "24 in", "18 in"],
        ["Spinach", "12 in", "6 in"],
        ["Onion", "12 in", "4 in"],
        ["Bush bean", "18 in", "6 in"],
        ["Broccoli", "24 in", "18 in"],
        ["Radish", "6 in", "2 in"],
      ],
      sourceHtml:
        'Sources: <a href="https://extension.uga.edu/content/dam/extension-county-offices/gwinnett-county/anr/homeshow-resources/Vegetable%20Planting%20Chart.pdf">UGA Cooperative Extension planting chart</a>; <a href="https://cmg.extension.colostate.edu/Gardennotes/721.pdf">Colorado State Extension raised-bed planting guide</a>; <a href="https://content.ces.ncsu.edu/extension-gardener-handbook/16-vegetable-gardening">NC State Extension vegetable gardening handbook</a>.',
    },
    faqs: [
      {
